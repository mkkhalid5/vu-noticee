...
public class MainActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		...
		button1.setBackground(new GradientDrawable() { public GradientDrawable getIns(int a, int b) { this.setCornerRadius(a); this.setColor(b); return this; } }.getIns((int)45, 0xFFFC8585));
		button1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/barlo.ttf"), 1);
		textview1.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/barlo.ttf"), 1);
	}
	...
	public void _LoadingProgressDialogue(final boolean _ifShow, final String _title) {
		if (_ifShow) {
			if (prog == null){
